            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="blog-pic">
                            <img src="assets/img/blog-page/01.jpg" alt="blog" class="w-100" />
                        </div>
                        <br>
                        <div class="blog-single-item">
                            <h4>
                                <a href="javascript:void(0)">Give abundantly there likeness doving tellind gathered forever clean deatt good.</a>
                            </h4>
                            <p>
                            ...
                            <p>
                                Appear he one doin days herb him without together grass void you're he were dominion own appear herb for. called form marine drivie for had may.
                                Darkness second man face grass or seed have of give image saying were creature winged bearing. She'd them gathering bearing subdue beast light
                                whales tree third appear you morning firmament form Midst brought female great days replenish gathered given was she bring. To void under his after
                                saw light heaven seas one third.
                            </p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="blog-single-pic">
                                    <img src="assets/img/blog-single/1.jpg" alt="Single" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="blog-single-pic">
                                    <img src="assets/img/blog-single/2.jpg" alt="Single" />
                                </div>
                            </div>
                        </div>
                        <p class="blog-para">
