            ...
            <div class="row">
                <div class="col-12">
                    <div class="feature-title text-center">
                        ...
                        <h2>Drink <span>The</span> Difference</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="support-content">
                        <div class="support-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="55" viewBox="0 0 45 55">
                                ...
                                <path id="https:_www.flaticon.com_free-icon_drops_1691455_term_water_page_1_position_77"
    ...
    <section class="company-section about-company-section">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="testimonial-title">
                        ...
                        <h2>Happy <span>Customer</span> Says</h2>
                    </div>
                </div>
            </div>
            <div class="row">
